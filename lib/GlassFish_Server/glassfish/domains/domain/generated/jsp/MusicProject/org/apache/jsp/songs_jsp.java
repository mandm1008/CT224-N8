...
public final class songs_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 for (int i = 0; i < mostViewSongs.size(); i++) {
      ...
      out.print(so.title);
      out.write("</div>\n");
      out.write("                        <div class=\"music-menu--button\" onclick=\"window.location = '");
      out.print(contextPath);
      out.write("/songs.jsp?id=");
      out.print(so.songId);
      out.write("'\">\n");
      ...
      out.write("                        </div>\n");
      out.write("                        <div class=\"music-menu--button\" onclick=\"pagePlayerManager.downloadSong(`");
      out.print(so.href);
      out.write("`)\">\n");
      out.write("                            <img src=\"");
      out.print(contextPath);
      ...
      out.write("                        </div>\n");
      out.write("                        <div class=\"music-menu--button\" onclick=\"pagePlayerManager.shareSong(`");
      out.print(so.songId);
      out.write("`)\">\n");
      out.write("                            <img src=\"");
      out.print(contextPath);
 ...
 for (int i = 0; i < userSongs.size(); i++) {
      ...
      out.write("\n");
      out.write("                    const rect = musicElement.getBoundingClientRect();\n");
      out.write("                    const menuRect = menuMusic.getBoundingClientRect();\n");
      out.write("\n");
      out.write("                    if (rect.right + menuRect.width > window.innerWidth) {\n");
      out.write("                        menuMusic.style.left = 'auto';\n");
      out.write("                        menuMusic.style.right = '50%'; // Hiển thị ở bên trái\n");
      out.write("                    } else {\n");
      out.write("                        menuMusic.style.left = '100%';\n");
      out.write("                        menuMusic.style.right = 'auto';\n");
      out.write("                    }\n");
      out.write("\n");
      ...
      out.write("                            if (typeof titleMenuElement !== \"undefined\") {\n");
